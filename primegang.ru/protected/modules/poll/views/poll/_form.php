...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <table id="poll-choices" class="table">
    <thead>
      <th>Сортировка</th>
      <th>Название</th>
      <th>Действия</th>
    ...
    <tr id="add-pollchoice-row">
      <td class="weight"></td>
      <td class="label">
        <?php echo CHtml::textField('add_choice', '', array('size'=>60, 'id'=>'add_choice','class'=>'form-control')); ?>
        <div class="errorMessage" style="display:none">Введите название.</div>
      </td>
      <td class="actions">
        <a href="#" id="add-pollchoice">Добавить вариант</a>
      </td>
    </tr>
    </tbody>
  </table>
