...
<div class="row content">
    <div class="container">
        <div class="col-lg-18 left">
            <div class="league">
                <h1 class="league_title"><span class="<?php echo $model->alias; ?>"></span><?php echo $model->name; ?>
                </h1>
                ...
                <div class="tours">
                    ...
                    <?php if (!$archive) :
                        ...
                        if (!empty($tour)) : ?>
                            <div class="tour next">
                                <a class="btn-block tourinfo" data-toggle="collapse"
                                   href="#collapse<?php echo $tour->id; ?>" aria-expanded="true"
                                   aria-controls="collapseExample">
                                    <div class="tour_next_prev">Следующий тур</div>
                                    <div class="tour_date"><?php if (!empty($tour->season)) ?>(<?php echo $tour->season->name; ?>
                                        )
                                    </div>
                                    <div class="tour_number"><?php echo $tour->name; ?></div>
                                </a>
                                <div class="collapse tour_results in" id="collapse<?php echo $tour->id; ?>"
                                     aria-expanded="true">
                                    <?php if (Yii::app()->user->isGuest): ?>
                                        <div class="alert alert-danger" style="margin:20px;" role="alert">
                                            <a href="/user/register">Зарегистрируйтесь</a> или <a href="/user/login">войдите</a>,
                                    ...
                                    <?php else: ?>
                                        <form class="form form-prognosis" method="POST" action="/prognosis/update">
                                            ...
                                            foreach ($games as $game):
                                                ...
                                                ?>
                                                <div class="tour_result <?php if ($hasProg) echo "sent"; ?>"
                                                     data-gameid="<?php echo $game->id; ?>">
                                                    <span><?php echo $game->date; ?><b class="msg"
                                                                                       style="display:none;">прогноз принят</b></span>
                                                    <div class="tour_result_team first">
                                                        <span><?php echo $game->team1->name; ?></span>
                                                        <?php if (strtotime($game->date) >= time()): ?>
                                                            <input name="Prognosis[<?php echo $game->id; ?>][score_team1]"
                                                                   value="<?php
                                                                   if ($hasProg) echo $prognosis->score_team1_total;
                                                                   ?>" data-type="score" data-column="score_team1"
                                                                   data-gameid="<?php echo $game->id; ?>"/>
                                                        <?php else: ?>
                                                            <!--закрываем прогноз-->
                                                            <div class="pull-right">
                                                                <?php if ($hasProg): echo "<b style='font-size:14px;'>" . $prognosis->score_team1_total . "</b>"; else: ?>
                                                                    <span class="closed glyphicon glyphicon-remove"></span><?php endif; ?>
                                                            </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <div class="tour_result_team second">
                                                        ...
                                                        <?php if (strtotime($game->date) >= time()): ?>
                                                            <input name="Prognosis[<?php echo $game->id; ?>][score_team2]"
                                                                   value="<?php
                                                                   if ($hasProg) echo $prognosis->score_team2_total;
                                                                   ?>" data-type="score" data-column="score_team2"
                                                                   data-gameid="<?php echo $game->id; ?>">
                                                        <?php else: ?>
                                                            <!--закрываем прогноз-->
                                                            <div class="pull-right">
                                                                <?php if ($hasProg): echo "<b style='font-size:14px;'>" . $prognosis->score_team2_total . "</b>"; else: ?>
                                                                    <span class="closed glyphicon glyphicon-remove"></span><?php endif; ?>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
...
//                        if ($tour->id_season != $season) continue;
                        ...
                        <div class="tour prev">
                            <a class="btn-block tourinfo" data-toggle="collapse"
                               href="#collapse<?php echo $tour->id; ?>"
                            ...
                            <div class="collapse <?php echo ($expanded) ? "in" : ""; ?>"
                                 id="collapse<?php echo $tour->id; ?>"
                                 aria-expanded="<?php echo ($expanded) ? "true" : "false"; ?>">
                                        ...
                                        <div class="tour_result">
                                            ...
                                            <div class="tour_result_team first">
                                                ...
                                                <?php if (!empty($user_prognosis)): ?>
                                                    <span class="prognosis" data-toggle="tooltip" data-placement="top"
                                                          title="Ваша ставка"><?php echo $user_prognosis->score_team1_total; ?></span>
                                                <?php endif; ?>
                                            </div>
                                            <div class="tour_result_team second">
                                                <span><?php echo $game->team2->name; ?></span>
                                                ...
                                                <?php if (!empty($user_prognosis)): ?>
                                                    <span class="prognosis" data-toggle="tooltip" data-placement="top"
                                                          title="Ваша ставка"><?php echo $user_prognosis->score_team2_total; ?></span>
                                                <?php endif; ?>
                                            </div>
                                            <?php if (!empty($user_prognosis)): ?>
                                                <div class="points">Ваши баллы
                                                    <span><?php echo $user_prognosis->balls; ?></span></div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
...
//                                CVarDumper::dump($tour->season, 5, true);
                                if (!empty($fullStats)):?>
                                    <div class="leaders">
