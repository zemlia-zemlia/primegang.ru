...
<span style="display:none;"><?php $stats = PrognoseFunctions::getSudokuGoalsStats(null, $season->alias);?></span>

<div class="row content">
	<div class="container">
		<div class="col-lg-18 left">
			<div class="league touronline">
				<h1 class="league_title"><span class="sudoku"></span>Лучшие голеадоры турнира VIVA SUDOKU!</h1>
